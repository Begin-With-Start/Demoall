...
public class ClipImageBorder extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(mContext.getResources().getColor(R.color.common_color_upload_fail_99000000));
        ...
        // 绘制外边框
        mPaint.setColor(mContext.getResources().getColor(R.color.common_color_c5_ffffff));
