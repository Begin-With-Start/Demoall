 ...
 * desc: 属性动画
 */
public class ObjectAnimatorOwnTest extends Activity implements View.OnClickListener{
    ...
    private void initView() {
         ...
         * alpha  view的透明度 0~1
         */
        objectAnimator = new ObjectAnimator().ofInt(new WrapBean(objectanimatorId),"width",500);
